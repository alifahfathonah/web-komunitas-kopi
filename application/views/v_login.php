...
<body style="background-color:#db2e34;">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <h2 class="p-4 text-gray-900 border-bottom-primary">Website Komunitas Kopi</h2>
                        <!-- Nested Row within Card Body -->
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block text-center mt-1 pl-5 pt-2">
                                <img src="<?=base_url('assets/img/');?>logo.png" alt="Login Image" height="350">
                            </div>
                            <div class="col-lg-7">
                                <div class="p-5">
